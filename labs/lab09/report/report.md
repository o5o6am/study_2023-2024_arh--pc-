...
![Подготовка новой программы](image/17.png){#fig:017 width=70%}
...
![Проверка работы стека](image/19.png){#fig:019 width=70%}
...
![Измененная программа предыдущей лабораторной работы](image/20.png){#fig:020 width=70%}
...
next:
    ...
    call f_x ; Вызов подпрограммы для вычисления f(x)

    add esi, eax ; Сохраняем результат в esi
...
![Поиск ошибки в программе через пошаговую отладку](image/21.png){#fig:021 width=70%}

Исправляю найденную ошибку, теперь программа верно считает значение функции (рис. -@fig:020).

![Проверка корректировок в программме](image/22.png){#fig:022 width=70%}
