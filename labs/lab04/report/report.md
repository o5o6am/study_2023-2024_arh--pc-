...
![Установка nasm через терминал](image/10.jpg){ #fig:010 width=70% }
...
Открываю текстовый редактор gedit

![Открываю gedit](image/13.jpg){ #fig:013 width=70% }

Вношу изменения в текст программы в файле lab4.asm так, чтобы вместо Hello world! на экран выводилась строка с моим фамилией и именем.
